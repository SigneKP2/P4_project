...
symbols <- read.csv("C:....tickers.csv")[, "symbol_test"][0:10]
market_caps <- read.csv("C:....tickers.csv")[, "market_cap_test"][0:10]
...
all_returns <- read.csv("C:....returns_new.csv")
...
mean_variance_weights_0.1 <- read.csv("C:....weights_test.csv")[, "mean_variance_weights_risk_free.0.1."]

mean_variance_weights_0.25 <- read.csv("C:....weights_test.csv")[, "mean_variance_weights_risk_free.0.25."]

mean_variance_weights_0.5 <- read.csv("C:....weights_test.csv")[, "mean_variance_weights_risk_free.0.5."]
